...
例：
  - 弁当1個・サラダ3個
    → サラダ150円（セット）×1個、250円（通常）×2個
  - 弁当2個・サラダ3個
    → サラダ150円（セット）×2個、250円（通常）×1個
```
...
```mermaid
---
title: Sales Tracking POS System - Entity Relationship Diagram
config:
  theme: default
  look: handDrawn
  layout: elk
